-- Migration 003: Add deferred/backoff lifecycle for dream evidence events
-- Timestamp: 2026-03-30
-- Description: Prevent skipped evidence from reprocessing forever
...
SELECT
  ...
  created_at,
  consumed_at,
  CASE WHEN status = 'discarded' THEN consumed_at ELSE NULL END
